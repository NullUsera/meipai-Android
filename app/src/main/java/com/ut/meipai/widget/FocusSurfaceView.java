...
public class FocusSurfaceView extends SurfaceView {
    ...
    private void addFocusToWindow() {
        if (va == null) {
            ...
            imageView.setImageResource(R.drawable.img_video_focus);
            ...
            va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    if (imageView != null) {
                        ...
                        if (value <= 0.5f) {
                            imageView.setScaleX(1 - value / 2);
                            imageView.setScaleY(1 - value / 2);
                        } else {
                            imageView.setScaleX(0.5f + value / 2);
                            imageView.setScaleY(0.5f + value / 2);
                        }
                    }
                }
            });
